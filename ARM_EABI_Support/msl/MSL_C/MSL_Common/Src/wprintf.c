...
static unsigned int set_base(wchar_t conversion_char)
{
	unsigned int base;
...
static wchar_t * justify_conversion(unsigned int base, int digits, int minus, wchar_t * p,
...
{
	return (__fwrite(Buffer, sizeof(wchar_t), NumChars, (FILE *)File) == NumChars ? File : 0);  /*- mm 040428 -*/
}
...
int _MSL_CDECL wprintf(const wchar_t * _MSL_RESTRICT format, ...)
{
	...
	#if (defined(__PPC_EABI__)  || defined(__MIPS__))              
	{
		...
		va_start( args, format );                
	  	result = __wpformatter(&__wFileWrite, (void *)stdout, format, args, 0);				/*- mm 001018 -*/
	}
	#else
		result = __wpformatter(&__wFileWrite, (void *)stdout, format, __va_start(format), 0);	/*- mm 001018 -*/
...
int _MSL_CDECL wprintf_s(const wchar_t * _MSL_RESTRICT format, ...)
{
	int result;		
	...
	#if (defined(__PPC_EABI__)  || defined(__MIPS__))              
	{
		va_list args;                            
		va_start( args, format );                
	  	result = __wpformatter(&__wFileWrite, (void *)stdout, format, args, 1);				/*- mm 001018 -*/
	}
	#else                                        
		result = __wpformatter(&__wFileWrite, (void *)stdout, format, __va_start(format), 1);	/*- mm 001018 -*/
	#endif	/* __PPC_EABI__ || __MIPS__  */
...
#else
	result = __wpformatter(&__wFileWrite, (void *)file, format, __va_start(format), 0);/*- mm 001018 -*/
#endif	/* __PPC_EABI__ || __MIPS__ */
...
int _MSL_CDECL fwprintf_s(FILE * _MSL_RESTRICT file, const wchar_t * _MSL_RESTRICT format, ...)
{
	int result;											/*- mm 001018 -*/
	int crtrgn;
...
#else                                        
	result = __wpformatter(&__wFileWrite, (void *)file, format, __va_start(format), 1);/*- mm 001018 -*/
#endif	/* __PPC_EABI__ || __MIPS__ */
...
int _MSL_CDECL vwprintf_s(const wchar_t * _MSL_RESTRICT format, va_list arg)
{
	int retval;															/*- mm 001018 -*/
	if (format == NULL)
	{
...
int _MSL_CDECL vfwprintf_s(FILE * _MSL_RESTRICT file, const wchar_t * _MSL_RESTRICT format, va_list arg)
{
	int retval;															/*- mm 001018 -*/
	int crtrgn;								/*- mm 020627 -*/
	if ((file == NULL) || (format == NULL))
...
int _MSL_CDECL swprintf_s(wchar_t * _MSL_RESTRICT s, rsize_t n, const wchar_t * _MSL_RESTRICT format, ...)
{
#if (defined(__PPC_EABI__)    || defined(__MIPS__))
	va_list args;                        							/*- scm 970709 -*/
	va_start( args, format );            							/*- scm 970709 -*/
...
int _MSL_CDECL snwprintf_s(wchar_t * _MSL_RESTRICT s, rsize_t n, const wchar_t * _MSL_RESTRICT format, ...)
{
#if (defined(__PPC_EABI__)    || defined(__MIPS__))
	va_list args;                        							/*- scm 970709 -*/
	va_start( args, format );            							/*- scm 970709 -*/
...
int _MSL_CDECL vswprintf_s(wchar_t * _MSL_RESTRICT s, rsize_t n, const wchar_t * _MSL_RESTRICT format, va_list arg)
{
	int retval;
...
int _MSL_CDECL vsnwprintf_s(wchar_t * _MSL_RESTRICT s, rsize_t n, const wchar_t * _MSL_RESTRICT format, va_list arg)
{
	int		count;
	__wOutStrCtrl wosc;
