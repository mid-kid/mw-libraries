...
_MSL_IMP_EXP_C float _MSL_MATH_CDECL rintf(float x) _MSL_CANT_THROW
{
	return((float)rint(x)); 
}
#endif  
 ...
 * cc  060303 Using suns erf
 * cc  070321 Added rintf
 */