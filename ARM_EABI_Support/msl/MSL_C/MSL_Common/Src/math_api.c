...
#if ((_MSL_USES_SUN_MATH_LIB && _MSL_FLOATING_POINT) || __dest_os == __mac_os_x)
...
{
	return((_INT32)(__HI(x)&0x80000000)) != 0;
}
...
{
	return((_INT32)(__UHI(x)&0x80000000)) != 0;
}
 ...
 * MA  070427 Removed _MSL_HIWARE_COMP
 */
