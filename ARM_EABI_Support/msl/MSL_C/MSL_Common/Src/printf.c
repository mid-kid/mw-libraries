...
#if _MSL_C99_PRINTF_SCANF || _MSL_FLOATING_POINT || _MSL_FLOATING_POINT_IO
	#include <ansi_fp.h>
	#include <float.h>
	#include <lconv.h>
	#include <locale.h>
	#include <msl_thread_local_data.h>
#endif /* MSL_C99_PRINTF_SCANF || _MSL_FLOATING_POINT || _MSL_FLOATING_POINT_IO */
...
#ifndef __VEC__
	#define vec_va_arg(ap) (*(((MWVector128 *) (ap = (void *) ((((unsigned long) ap + 15) & ~(15)) + 16))) -1))
...
int _MSL_CDECL printf(const char * _MSL_RESTRICT format, ...)														/*- cc 010821 -*/								
{
	...
	{ 
		...
		result = __pformatter(&__FileWrite, (void *)stdout, format, args, 0);					/*- mm 001013 -*/
	}
	#else                                        
		result = __pformatter(&__FileWrite, (void *)stdout, format, __va_start(format), 0);	/*- mm 001013 -*/
...
int _MSL_CDECL printf_s(const char * _MSL_RESTRICT format, ...)														/*- cc 010821 -*/								
{
	int result;
...
int _MSL_CDECL fprintf(FILE * _MSL_RESTRICT file, const char * _MSL_RESTRICT format, ...)			/*- cc 010821 -*/
{
	...
	va_start( args, format );                
	result = __pformatter(&__FileWrite, (void *)file, format, args, 0);/*- mm 001013 -*/
	}
#else                                        
	result = __pformatter(&__FileWrite, (void *)file, format, __va_start(format), 0);/*- mm 001013 -*/
#endif	/* __PPC_EABI__ || __MIPS__ */
...
int _MSL_CDECL fprintf_s(FILE * _MSL_RESTRICT file, const char * _MSL_RESTRICT format, ...)
{
	int result;
	int crtrgn;
	...
	va_start( args, format );                
	result = __pformatter(&__FileWrite, (void *)file, format, args, 1);/*- mm 001013 -*/
	}
#else                                        
	result = __pformatter(&__FileWrite, (void *)file, format, __va_start(format), 1);/*- mm 001013 -*/
#endif	/* __PPC_EABI__ || __MIPS__ */
...
int _MSL_CDECL vprintf_s(const char * _MSL_RESTRICT format, va_list arg)
{
	...
	retval = __pformatter(&__FileWrite, (void *)stdout, format, arg, 1);		/*- mm 001013 -*/
...
int _MSL_CDECL vfprintf_s(FILE * _MSL_RESTRICT file, const char * _MSL_RESTRICT format, va_list arg)
{
	int retval;											/*- mm 001013 -*/
	int crtrgn;											/*- mm 020627 -*/
...
int _MSL_CDECL vsnprintf_s(char * _MSL_RESTRICT s, size_t n, const char * _MSL_RESTRICT format, va_list arg)
{
	int		end;
	__OutStrCtrl osc;
...
int _MSL_CDECL vsprintf_s(char * _MSL_RESTRICT s, rsize_t n, const char * _MSL_RESTRICT format, va_list arg)
{
	int retval;
...
int _MSL_CDECL snprintf_s(char * _MSL_RESTRICT s, rsize_t n, const char * _MSL_RESTRICT format, ...)
{
#if defined(__PPC_EABI__) || defined(__MIPS__)									/*- cc 010821 -*/
{
	va_list args;
...
#if (__dest_os != __n64_os)  							/*- ard 990126 -*/	/*- cc 010821 -*/
...
int _MSL_CDECL sprintf_s(char * _MSL_RESTRICT s, rsize_t n, const char * _MSL_RESTRICT format, ...)
{
  #if defined(__PPC_EABI__) || defined(__MIPS__)
  	{ 														/*- cc 010821 -*/
		va_list args;
