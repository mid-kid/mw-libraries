...
#include <ansi_parms.h>
	...
	#define FE_FLTPREC			((short)(2))
		...
		typedef short fenv_t;
		/* FP EXCEPTION FLAGS */
		#define FE_INVALID		0x8000
		#define FE_UNDERFLOW	0x2000
		#define FE_OVERFLOW		0x4000
		#define FE_DIVBYZERO	0x1000
		#define FE_INEXACT		0x0800
	#endif	/* __COLDFIRE__ */
	
	/* ROUNDING MODES */
	#define FE_TONEAREST		0x0000
	#define FE_TOWARDZERO		0x0010
	#define FE_DOWNWARD			0x0020
	#define FE_UPWARD			0x0030
	/* PRECISION ROUNDING */
	#define FE_DBLPREC			0x00
	#define FE_FLTPREC			0x40
#endif /* __COLDFIRE__ */
...
_MSL_IMP_EXP_C int _MSL_MATH_CDECL feclearexcept ( int ) _MSL_CANT_THROW;
_MSL_IMP_EXP_C int _MSL_MATH_CDECL fegetexceptflag ( fexcept_t *, int ) _MSL_CANT_THROW;
_MSL_IMP_EXP_C int _MSL_MATH_CDECL fesetexceptflag ( const fexcept_t *, int ) _MSL_CANT_THROW;
...
#elif ! __COLDFIRE__
	_MSL_IMP_EXP_C int _MSL_MATH_CDECL fegetexcept (fexcept_t *, int) _MSL_CANT_THROW;
	_MSL_IMP_EXP_C void _MSL_MATH_CDECL fesetexcept (const fexcept_t *, int ) _MSL_CANT_THROW;
#endif
_MSL_IMP_EXP_C int _MSL_MATH_CDECL feraiseexcept (int) _MSL_CANT_THROW;
...
_MSL_IMP_EXP_C int _MSL_MATH_CDECL fegetenv ( fenv_t * ) _MSL_CANT_THROW;
_MSL_IMP_EXP_C int _MSL_MATH_CDECL feholdexcept ( fenv_t * ) _MSL_CANT_THROW;
_MSL_IMP_EXP_C int _MSL_MATH_CDECL fesetenv ( const fenv_t * ) _MSL_CANT_THROW;
_MSL_IMP_EXP_C int _MSL_MATH_CDECL feupdateenv ( const fenv_t *  ) _MSL_CANT_THROW;
#if (defined(__MC68K__)  || defined(__COLDFIRE__)  || defined(__INTEL__))
