...
_MSL_IMP_EXP_C float _MSL_MATH_CDECL scalbnf(float  x, int n)
{
	float mant;
	int    exp;
	float result;
 ...
 * cc  040210 Calling the ARM floating point library for assembly versions of lrint and 
 *			  llrint.
 */