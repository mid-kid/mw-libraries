/*---------------------------------------------------------------------------*
  ...
  $Log: uncompress.h,v $
  Revision 1.12  01/18/2006 02:12:29  kitase_hirotake
  do-indent
  ...
  Revision 1.9  11/30/2004 07:40:22  takano_makoto
  Added MICompressionHeader structure

  Revision 1.8  11/15/2004 07:53:18  takano_makoto
...
typedef struct
{
    u16     srcNum;                    // Source data. Number of bytes.  xyxyxy
    u16     srcBitNum:8;               // 1 source data. Number of bits.  xyxyxy
    u16     destBitNum:8;              // 1 destination data. Number of bits. xyxyxy
...
//
//* Expands 0 fixed bit packed data.  xyxyxy
...
//    u16 srcNum              Source data. Number of bytes.  xyxyxy
//    u8  srcBitNum           1 Source data. Number of bits. xyxyxy
//    u8  destBitNum          1 Destination data. Number of bits.  xyxyxy
...
//- If the size of the compressed data is not a multiple of 4,  xyxyxy
//  where possible adjust by packing with 0.  xyxyxy
