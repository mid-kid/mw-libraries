/*---------------------------------------------------------------------------*
  ...
  $Log: tcm.h,v $
  Revision 1.13  01/18/2006 02:12:28  kitase_hirotake
  do-indent

  Revision 1.12  02/28/2005 05:26:02  yosizaki
  do-indent.

  Revision 1.11  02/17/2005 11:39:00  yosizaki
  add OS_GetITCMAddress.

  Revision 1.10  06/11/2004 06:23:03  yada
  and remove OS_SetITCMAddress

  Revision 1.9  06/08/2004 12:21:52  yada
  change names
  ParamDTCM->DTCMParam, ParamITCM->ITCMParam

  Revision 1.8  06/02/2004 12:13:02  yada
  fix comment.
  ...
  Revision 1.6  02/10/2004 12:11:49  yada
  Moved OS_GetDTCMAddress, OS_GetITCMAddress from system.h

  Revision 1.5  02/05/2004 07:27:19  yada
  ...
  Revision 1.2  01/15/2004 02:40:01  yada
