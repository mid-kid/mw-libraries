/*---------------------------------------------------------------------------*
  ...
  Revision 1.17  10/14/2005 06:37:35  yada
  let some arguments of functions be const

  Revision 1.16  02/28/2005 05:26:02  yosizaki
  do-indent.

  Revision 1.15  01/24/2005 00:23:43  takano_makoto
  fix Copyright header.

  Revision 1.14  01/21/2005 10:40:39  takano_makoto
  Added DC_Unlockdown, DC_UnlockdownAll, IC_Unlockdown, IC_UnlockdownAll.

  Revision 1.13  11/02/2004 09:58:29  yada
  just fix comment

  Revision 1.12  04/07/2004 05:45:59  yada
  (none)

  Revision 1.11  04/07/2004 05:29:40  yada
  (1.10 comment was wrong)
  add explanation for function

  Revision 1.10  04/07/2004 05:05:02  yada
  axf->nef
  ...
  Revision 1.6  01/14/2004 08:41:52  yada
  cache function name definitions xyxyxy

  Revision 1.5  12/18/2003 01:53:12  yada
  Made corrections.

  Revision 1.4  12/17/2003 11:29:49  yada
  Coded data cache functions.

  Revision 1.3  12/17/2003 09:39:34  nishida_kenji
  small bug fix

  Revision 1.2  12/17/2003 09:28:20  yada
