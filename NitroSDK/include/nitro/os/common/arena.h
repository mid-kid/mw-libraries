/*---------------------------------------------------------------------------*
  ...
  Revision 1.16  02/28/2005 05:26:01  yosizaki
  do-indent.

  Revision 1.15  12/21/2004 11:24:27  yada
  add OS_EnableMainExArena() / OS_DisableMainExArena()

  Revision 1.14  08/31/2004 01:08:37  yada
  arrange comments

  Revision 1.13  07/08/2004 02:29:03  yada
  fix a little

  Revision 1.12  07/08/2004 02:28:00  yada
  add OS_InitArenaEx(),  setting for extended mainRam arena

  Revision 1.11  04/07/2004 02:03:17  yada
  fix header comment

  Revision 1.10  02/19/2004 08:44:06  yada
  Removed workaround.

  Revision 1.9  2004/02/14 06:32:14  yasu
  workaround to keep compatibility

  Revision 1.8  02/13/2004 10:38:26  yada
  Changed from 6 to 9 arenas.

  Revision 1.7  2004/02/05 07:09:03  yasu
  change SDK prefix iris -> nitro

  Revision 1.6  01/17/2004 02:28:38  nishida_kenji
  convert 'inline' to 'static inline' in header files

  Revision 1.5  01/16/2004 04:05:36  yada
  Added an extended MainMemory area arena.

  Revision 1.4  01/15/2004 12:13:27  yada
  Added arena structure definition.

  Revision 1.3  12/26/2003 08:21:33  yada
  Defined OS_InitArena()

  Revision 1.2  12/26/2003 07:17:42  yada
  Changed ArenaType -> ArenaId.

  Revision 1.1  12/26/2003 06:43:49  yada
  Initial release.
