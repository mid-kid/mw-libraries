/*---------------------------------------------------------------------------*
  ...
  Revision 1.14  07/11/2005 05:05:08  yada
  fix around static inline

  Revision 1.13  02/28/2005 05:26:01  yosizaki
  do-indent.

  Revision 1.12  05/12/2004 10:58:53  yada
  optional r0,r1,r2,r3 each

  Revision 1.11  05/12/2004 08:19:12  yada
  fix bad endif

  Revision 1.10  05/12/2004 08:03:01  yada
  fix include guard

  Revision 1.9  05/12/2004 05:07:12  yada
  modify SDK_XXX / OS_XXX option

  Revision 1.8  05/10/2004 11:45:40  yada
  consider for functionCost

  Revision 1.7  04/26/2004 01:44:49  yada
  OSi->OS: about OS_Enable/Disable/RestoreCallTrace

  Revision 1.6  04/23/2004 06:01:48  yada
  fix spell mistake

  Revision 1.5  04/23/2004 00:30:02  yada
  added support for log mode

  Revision 1.4  04/15/2004 02:28:14  yada
  consider for FINALROM

  Revision 1.3  04/14/2004 02:57:50  yada
  CALLSTACK->CALLTRACE

  Revision 1.2  04/13/2004 06:21:58  yada
  added OS_DumpThreadCallTrace() (only explanation)

  Revision 1.1  04/12/2004 12:11:14  yada
  first release
