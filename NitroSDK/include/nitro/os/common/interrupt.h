/*---------------------------------------------------------------------------*
  ...
  $Log: interrupt.h,v $
  Revision 1.61  01/18/2006 02:11:19  kitase_hirotake
  do-indent

  Revision 1.60  07/19/2005 06:05:47  yada
  add irq stack check

  Revision 1.59  03/01/2005 01:57:00  yosizaki
  Revised copyright year

  Revision 1.58  02/28/2005 05:26:01  yosizaki
  do-indent.

  Revision 1.57  12/02/2004 07:16:44  yada
  OS_IE_USER_FLAG0, OS_IE_USER_FLAG1 become also available on ARM9

  Revision 1.56  11/02/2004 10:25:47  yada
  just fix comment

  Revision 1.55  2004/09/14 06:04:08  yada
  only fix comment

  Revision 1.54  09/02/2004 06:26:13  yada
  only change comment

  Revision 1.53  08/16/2004 04:22:59  yada
  in ARM9, no hook in VBlank interrupt

  Revision 1.52  08/10/2004 12:15:39  yada
  VBlank counter is in shared area

  Revision 1.51  08/10/2004 08:00:02  yada
  add OS_GetVBlankCount()
  fix comment

  Revision 1.50  06/28/2004 06:37:36  yada
  delete unused define

  Revision 1.49  05/25/2004 10:43:43  yada
  disable IME before touch IE or IF

  Revision 1.48  05/24/2004 04:48:29  yada
  OS_WaitIntr() -> OS_WaitInterrupt()

  Revision 1.47  05/10/2004 11:25:43  yada
  add #define guard to OSIrqMask

  Revision 1.46  05/01/2004 05:47:31  yada
  OS_WaitInterrupt->OS_WaitIrq, OS_WaitAnyInterrupt->OS_WaitAnyIrq

  Revision 1.45  04/30/2004 08:11:06  yada
  add OS_WaitAnyInterrupt

  Revision 1.44  04/30/2004 02:20:31  yada
  add OS_WaitInterrupt()

  Revision 1.43  2004/04/21 12:38:48  yasu
  add OS_IE_USER_FLAG0,1

  Revision 1.42  04/15/2004 12:50:34  yada
  divide OS_IrqHandler to 2 function

  Revision 1.41  04/07/2004 02:03:17  yada
  fix header comment

  Revision 1.40  04/06/2004 09:00:49  yada
  add OS_ClearIrqFlag(), OS_GetIrqFlag()
  add function comments

  Revision 1.39  03/18/2004 12:55:26  yada
  Made so included files are not nitro.h, but only the necessary ones.  xyxyxy

  Revision 1.38  03/16/2004 07:08:38  yada
