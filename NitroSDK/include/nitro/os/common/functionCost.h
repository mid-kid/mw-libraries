/*---------------------------------------------------------------------------*
  ...
  Revision 1.10  07/11/2005 05:05:08  yada
  fix around static inline

  Revision 1.9  02/28/2005 05:26:01  yosizaki
  do-indent.

  Revision 1.8  10/07/2004 12:38:10  yada
  fix around OS_CalcThreadStatistics()

  Revision 1.7  05/18/2004 06:35:15  yada
  consider for thread that is not current

  Revision 1.6  05/18/2004 06:10:38  yada
  consider for thread interval

  Revision 1.5  05/12/2004 10:59:42  yada
  fix structure offset description

  Revision 1.4  05/12/2004 08:19:26  yada
  fix bad endif

  Revision 1.3  05/12/2004 08:03:01  yada
  fix include guard

  Revision 1.2  05/12/2004 05:07:40  yada
  modify SDK_XXX / OS_XXX option

  Revision 1.1  05/10/2004 11:38:08  yada
  first release
...
/*---------------------------------------------------------------------------*
  ...
  Description:  disable functionCost
