/*---------------------------------------------------------------------------*
  ...
  $Log: timer.h,v $
  Revision 1.24  01/18/2006 02:12:28  kitase_hirotake
  do-indent

  Revision 1.23  03/01/2005 01:57:00  yosizaki
  Revised copyright year

  Revision 1.22  02/28/2005 05:26:01  yosizaki
  do-indent.

  Revision 1.21  11/24/2004 04:36:59  yada
  just fix typo

  Revision 1.20  09/02/2004 06:26:54  yada
  only change comment

  Revision 1.19  04/07/2004 02:03:17  yada
  fix header comment
  ...
  Revision 1.15  01/27/2004 01:47:52  yada
  Revised inline

  Revision 1.14  01/17/2004 02:28:38  nishida_kenji
  convert 'inline' to 'static inline' in header files

  Revision 1.13  01/08/2004 05:42:39  yada
  Revised ASSERT

  Revision 1.12  01/08/2004 05:06:34  yada
  Revised cast mistake.

  Revision 1.11  01/08/2004 04:55:48  yada
  Fixed timer setting bug. Added OS_StopTimer().

  Revision 1.10  12/25/2003 07:30:15  yada
  Changes as per unified type rules

  Revision 1.9  12/25/2003 00:19:29  nishida_kenji
  convert INLINE to inline

  Revision 1.8  11/17/2003 01:28:34  yada
  Fixed a mistake in assert.

  Revision 1.7  11/14/2003 04:58:11  yada
  Changed the register access macro from REG_XXX to reg_XXX

  Revision 1.6  11/13/2003 04:03:30  yada
  Discontinued OSENUM...

  Revision 1.5  11/05/2003 01:05:20  yada
  (none)

  Revision 1.4  11/05/2003 01:03:18  yada
  Made the cast more strict At least make it so no warnings appear.

  Revision 1.3  10/31/2003 04:11:37  yada
  "}" was missing for extern"C".

  Revision 1.2  10/30/2003 11:42:52  yada
  Decided to use REGTypexx in the register type

  Revision 1.1  10/30/2003 06:56:20  yada
