/*---------------------------------------------------------------------------*
  ...
  $Log: thread.h,v $
  Revision 1.77  01/18/2006 02:12:28  kitase_hirotake
  do-indent

  Revision 1.76  09/06/2005 06:22:34  yada
  consider for const OSThread*.

  Revision 1.75  08/09/2005 09:00:10  yada
  change OSThread struct. (not to change struct size)

  Revision 1.74  08/09/2005 01:40:55  yada
  change argument of OS_SetThreadDestructorStack

  Revision 1.73  08/08/2005 11:25:46  yada
  able to specify thread destructor stack.
  cancel alarm for OS_Sleep when that thread exits.

  Revision 1.72  07/19/2005 07:14:41  yada
  fix typo. OSi_SPECFIC_CPS -> OSi_SPECIFIC_CPS

  Revision 1.71  07/13/2005 02:13:35  yada
  fix around thread info offset

  Revision 1.70  07/11/2005 08:31:35  yada
  fixed around SDK_THREAD_INFINITY

  Revision 1.69  07/11/2005 00:46:16  yada
  add OSi_SetSpecificData() / OSi_GetSpecificData()

  Revision 1.68  07/08/2005 08:50:06  yada
  ...
  Revision 1.65  07/01/2005 09:20:06  yada
  specific size becomes 4

  Revision 1.64  07/01/2005 04:17:28  yada
  add system error number

  Revision 1.63  06/30/2005 11:23:41  yada
  add thread destructor and user parameter

  Revision 1.62  06/28/2005 09:49:44  yada
  applied for SDK_THREAD_INFINITY

  Revision 1.61  06/16/2005 07:57:31  yada
  add OS_YieldThread()

  Revision 1.60  02/28/2005 05:26:01  yosizaki
  do-indent.

  Revision 1.59  01/21/2005 04:21:34  yada
  add OS_Enable/DisableScheduler()

  Revision 1.58  01/11/2005 07:53:54  takano_makoto
  fix copyright header.

  Revision 1.57  01/07/2005 04:17:04  yada
  release OS_DestroyThread as public function

  Revision 1.56  11/02/2004 11:58:22  yada
  fix a little

  Revision 1.55  11/02/2004 09:49:24  yada
  just fix comment

  Revision 1.54  2004/10/04 10:06:12  yasu
  support SDK_NO_MESSAGE

  Revision 1.53  06/28/2004 06:28:47  yada
  only fix comment typo

  Revision 1.52  06/25/2004 04:41:54  yada
  add OS_JoinThread(), OS_IsThreadTerminate()

  Revision 1.51  06/08/2004 00:28:51  yada
  only fix spacing

  Revision 1.50  06/03/2004 04:28:10  yada
  member 'calltrace' becomes 'profiler'

  Revision 1.49  05/26/2004 10:32:08  yada
  fix comment

  Revision 1.48  05/26/2004 05:17:05  yada
  ...
  Revision 1.45  05/18/2004 06:36:56  yada
  only fix comment

  Revision 1.44  05/13/2004 05:35:19  yada
  add dummyPtr for structure size arrangement

  Revision 1.43  05/12/2004 12:13:58  yada
  delete unused define

  Revision 1.42  05/12/2004 05:13:41  yada
  modify SDK_XXX / OS_XXX option

  Revision 1.41  05/10/2004 12:05:07  yada
  consider for functionCost

  Revision 1.40  04/30/2004 02:17:20  yada
  add stack check function OS_GetStackStatus()

  Revision 1.39  04/27/2004 02:44:14  yada
  add function to get idle thread

  Revision 1.38  04/26/2004 07:37:25  yada
  only arrange indent

  Revision 1.37  04/19/2004 02:02:46  yada
  CALLSTACK->CALLTRACE

  Revision 1.36  04/14/2004 02:57:50  yada
  CALLSTACK->CALLTRACE

  Revision 1.35  04/13/2004 06:20:52  yada
  Added OS_DumpThreadCallTrace()

  Revision 1.34  04/12/2004 12:11:45  yada
  add callTrace.h

  Revision 1.33  04/07/2004 02:03:17  yada
  fix header comment

  Revision 1.32  04/02/2004 12:49:25  yada
  Added mutex queue to OSThread

  Revision 1.31  03/31/2004 09:25:14  yada
  add thread switch callback function

  Revision 1.30  03/30/2004 05:58:40  yada
  Added OS_IsThreadAvailable

  Revision 1.29  03/03/2004 07:03:44  yada
  Revised the location of the thread list pointer in the structure

  Revision 1.28  03/02/2004 11:54:29  yada
  Added OS_Sleep()

  Revision 1.27  02/26/2004 12:14:10  yada
  Priority range. Defined launch priority as 16.

  Revision 1.26  02/26/2004 09:42:04  yada
  Changed so that threads are managed in a priority list.

  Revision 1.25  02/26/2004 05:49:42  yada
  Added start function argument to OS_CreateThread().

  Revision 1.24  02/17/2004 09:29:21  yada
  Reshaped tab
  ...
  Revision 1.21  01/21/2004 12:02:05  yada
  Created a stack overflow check.

  Revision 1.20  01/18/2004 04:47:31  yada
  Reformed indents, etc.

  Revision 1.19  01/17/2004 02:28:38  nishida_kenji
  convert 'inline' to 'static inline' in header files

  Revision 1.18  12/25/2003 07:30:11  yada
  ...
  Revision 1.9  11/30/2003 02:08:23  yada
