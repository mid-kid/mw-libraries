/*---------------------------------------------------------------------------*
  ...
  Revision 1.11  07/20/2005 09:41:31  yada
  add OS_IsMessageQueueFull()

  Revision 1.10  07/20/2005 09:36:30  yada
  add OS_GetMessageCount()

  Revision 1.9  02/28/2005 05:26:01  yosizaki
  do-indent.

  Revision 1.8  04/07/2004 02:03:17  yada
  fix header comment

  Revision 1.7  03/12/2004 12:09:51  yada
  only fix comment

  Revision 1.6  03/12/2004 08:41:14  yada
  changed name from OS_PeepMessage() -> OS_ReadMessage()

  Revision 1.5  03/12/2004 02:39:12  yada
  added OS_PeepMessage()

  Revision 1.4  2004/02/05 07:09:03  yasu
  change SDK prefix iris -> nitro

  Revision 1.3  01/18/2004 04:47:31  yada
  Reformed indents, etc.

  Revision 1.2  12/25/2003 07:29:33  yada
  Changes as per unified type rules

  Revision 1.1  11/26/2003 01:51:38  yada
  Initial release.
