/*---------------------------------------------------------------------------*
  ...
  Revision 1.8  11/02/2004 11:58:22  yada
  fix a little

  Revision 1.7  11/02/2004 09:48:12  yada
  just fix comment

  Revision 1.6  2004/10/21 13:43:50  yasu
  Add  OS_VALARM_DELAY_MAX macro

  Revision 1.5  10/21/2004 06:11:29  yada
  Fix a lot.  Consider for delay.

  Revision 1.4  04/07/2004 02:03:17  yada
  fix header comment

  Revision 1.3  03/08/2004 05:35:03  yada
  Made so you can set the allowable delay range of periodic VCount

  Revision 1.2  03/02/2004 11:04:36  yada
  Took into consideration delay of V interrupt

  Revision 1.1  02/23/2004 11:57:58  yada
  firstRelease
