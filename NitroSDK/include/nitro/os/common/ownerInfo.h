/*---------------------------------------------------------------------------*
  ...
  Revision 1.13  05/14/2005 03:03:13  terui
  Corrected to define Chinese language code only when SDK_NVRAM_FORMAT is 300 and over

  Revision 1.12  04/26/2005 08:01:54  terui
  Fix comment

  Revision 1.11  04/18/2005 12:28:10  terui
  Deleted OSi_CheckOwnerInfo function

  Revision 1.10  04/12/2005 10:49:15  terui
  ...
  Revision 1.7  10/07/2004 10:19:39  yosizaki
  ...
  Revision 1.5  09/03/2004 08:43:07  terui
  Only fix comment.

  Revision 1.4  09/03/2004 08:00:53  terui
  ...
  Revision 1.1  09/02/2004 06:20:49  terui
  Initial upload
...
typedef enum OSLanguage
{
    ...
    OS_LANGUAGE_RESERVED = NVRAM_CONFIG_LANG_RESERVED,  // 7: Reserved
#endif
