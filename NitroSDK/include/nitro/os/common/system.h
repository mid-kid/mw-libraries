/*---------------------------------------------------------------------------*
  ...
  $Log: system.h,v $
  Revision 1.30  01/18/2006 02:12:28  kitase_hirotake
  do-indent

  Revision 1.29  10/07/2005 08:22:03  yada
  add OS_WaitVBlankIntr()

  Revision 1.28  08/31/2005 12:03:27  yada
  add OS_Exit()

  Revision 1.27  02/28/2005 05:26:01  yosizaki
  do-indent.

  Revision 1.26  11/24/2004 04:36:10  yada
  just fix typo

  Revision 1.25  09/02/2004 06:27:05  yada
  only change comment

  Revision 1.24  05/24/2004 04:48:29  yada
  OS_WaitIntr() -> OS_WaitInterrupt()

  Revision 1.23  05/10/2004 11:21:49  yada
  add OS_WaitIntr()

  Revision 1.22  04/07/2004 02:03:17  yada
  fix header comment

  Revision 1.21  04/06/2004 01:38:13  yada
  Changed behavior of OS_Halt()

  Revision 1.20  03/04/2004 09:48:20  yada
  IRQ prohibited OSDisableInterrupt()  xyxyxy
  ...
  Revision 1.17  02/13/2004 02:16:43  yada
  EnableInterrupts, GetProcMode for ARM7 (temporary)

  Revision 1.16  02/13/2004 01:51:33  yada
  ...
  Revision 1.14  02/10/2004 12:11:23  yada
  Migrated OS_GetDTCMAddress, OS_GetITCMAddress to tcm.h.

  Revision 1.13  02/10/2004 11:35:06  yada
  only arrange tab & space

  Revision 1.12  02/10/2004 11:19:21  yada
  Stop inline for interrupt function.

  Revision 1.11  02/09/2004 11:38:18  yada
