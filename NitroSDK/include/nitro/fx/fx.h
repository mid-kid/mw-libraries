/*---------------------------------------------------------------------------*
  ...
  $Log: fx.h,v $
  Revision 1.44  01/18/2006 02:11:20  kitase_hirotake
  do-indent

  Revision 1.43  11/14/2005 05:10:03  okubata_ryoma
  ...
  Revision 1.38  09/05/2005 09:57:13  takano_makoto
  Corrected FX_FX64C_TO_F32 macro

  Revision 1.37  03/01/2005 01:57:00  yosizaki
  Revised copyright year

  Revision 1.36  02/28/2005 05:26:13  yosizaki
  do-indent.

  Revision 1.35  2004/09/13 06:53:37  yasu
  SDK_ARM -> SDK_CODE_ARM

  Revision 1.34  06/14/2004 04:07:48  takano_makoto
  Added FX16_CONST, FX64_CONST and FX64C_CONST. Corrected FX_F32_TO_FX32.

  Revision 1.33  2004/05/25 00:19:47  yasu
  add FX32_CONST(x)

  Revision 1.32  05/14/2004 11:59:00  takano_makoto
  Add #ifndef SDK_FROM_TOOL for VC or BCB.

  Revision 1.31  03/23/2004 05:17:38  takano_makoto
  At FX_MUL, FX_MUL32x64C and FX_Mul32x64c, change to return round decimal.

  Revision 1.30  02/25/2004 06:24:27  nishida_kenji
  FX_Mul and FX_Mul32x64c become macros.

  Revision 1.29  02/16/2004 02:35:18  nishida_kenji
  Add VecFx16.

  Revision 1.28  02/13/2004 00:54:23  nishida_kenji
  Add FX_Modf.

  Revision 1.27  2004/02/05 07:09:03  yasu
  change SDK prefix iris -> nitro

  Revision 1.26  02/04/2004 11:49:33  nishida_kenji
  small fix.

  Revision 1.25  01/27/2004 11:15:10  nishida_kenji
  appends 'static' to inline function prototypes.

  Revision 1.24  01/26/2004 07:15:14  nishida_kenji
  revise FX_Mul and FX_Mul32x64c for thumb

  Revision 1.23  01/18/2004 04:37:11  nishida_kenji
  removes FX_Dot2, FX_Dot3, FX_Dot4

  Revision 1.22  01/17/2004 13:22:56  nishida_kenji
  small bug fix

  Revision 1.21  01/17/2004 08:32:01  nishida_kenji
  improve precision of FX_Mul32x64c

  Revision 1.20  01/17/2004 07:17:25  nishida_kenji
  ...
  Revision 1.18  01/16/2004 11:25:53  nishida_kenji
  small fix

  Revision 1.17  01/16/2004 10:38:39  nishida_kenji
  add FX_Init for table setup

  Revision 1.16  01/05/2004 06:29:03  nishida_kenji
  add FX_Whole, FX_Floor

  Revision 1.15  12/25/2003 00:19:29  nishida_kenji
  convert INLINE to inline

  Revision 1.14  12/18/2003 00:08:55  nishida_kenji
  removed VecFx16

  Revision 1.13  12/11/2003 09:18:28  nishida_kenji
  fix comments

  Revision 1.12  12/11/2003 06:17:47  nishida_kenji
  add FX_Dot4 and comments

  Revision 1.11  12/09/2003 11:27:02  nishida_kenji
  improve asserts and comments

  Revision 1.10  12/04/2003 07:31:50  nishida_kenji
