/*---------------------------------------------------------------------------*
  ...
  Revision 1.14  02/28/2005 05:26:27  yosizaki
  do-indent.

  Revision 1.13  04/07/2004 02:03:17  yada
  fix header comment

  Revision 1.12  03/30/2004 04:51:14  yada
  removed the line defining HW_DTCM_ARENA_HI_MAX   xyxyxy

  Revision 1.11  02/17/2004 08:20:44  yada
  removed the fixed SYS mode stack position definition

  Revision 1.10  02/16/2004 09:37:57  yada
  added definition for stack start address

  Revision 1.9  02/09/2004 11:32:48  yada
  ...
  Revision 1.7  01/27/2004 00:12:08  yada
  revised size of DTCM internal reserved area, etc

  Revision 1.6  01/16/2004 04:12:04  yada
  revised stack size definition

  Revision 1.5  01/15/2004 08:25:44  yada
  comments added

  Revision 1.4  01/08/2004 12:04:00  yada
  added 0x20 to DTCM reserved area

  Revision 1.3  01/07/2004 01:41:54  yada
