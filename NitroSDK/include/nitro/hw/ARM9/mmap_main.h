/*---------------------------------------------------------------------------*
  ...
  Corrected the size value for the memory map

  Revision 1.15  2005/04/14 06:58:28  yasu
   Corrected the memory map schematic 

  Revision 1.14  2005/04/13 12:47:59  terui Improvement:
