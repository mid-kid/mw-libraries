/*---------------------------------------------------------------------------*
  ...
  $Log: config.h,v $
  Revision 1.18  2005/04/12 10:49:15  terui Improvement:
  Modified to support Chinese language

  Revision 1.17  2005/02/28 05:26:03  yosizaki
  do-indent.

  Revision 1.16  2004/10/01 02:54:29  terui Improvement:
  ...
  Revision 1.13  2004/09/03 04:29:15  terui Improvement:
  Made corrections in line with the revamp of the structure definitions relating to the user information in NVRAM.

  Revision 1.12  2004/09/02 02:24:36  terui Improvement:
  ...
  Revision 1.9  2004/08/25 09:21:50  terui Improvement:
  Changed to put userInfo definition to different file, and switch to TS_VERSION  
  ...
  Revision 1.6  2004/06/30 10:36:18  terui Improvement:
  Changed the user info format definition in TS

  Revision 1.5  2004/06/30 09:12:11  terui Improvement:
  Changed the definition to use an offset to facilitate search of user info in NVRAM with TS   

  Revision 1.4  2004/05/21 07:57:30  terui Improvement:
  ...
  Revision 1.1  2004/05/20 09:41:06  terui Improvement:
...
#else
#define NVRAM_CONFIG_CONST_ADDRESS     // User info position is now a constant address   
#endif
